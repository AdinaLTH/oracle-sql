...
SELECT
    deptno
  , name
  , decode(deptno, 101, 'Computer Engineering', 102, 'Multimedia Engineering'
...
SELECT
  ...
  , name
  , birthday
  , decode(to_char(birthday, 'Q'), '1', '1/4분기', '2', '2/4분기'
           , '3', '3/4분기', '4', '4/4분기') AS 분기
  FROM
    student;
